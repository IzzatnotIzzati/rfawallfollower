...
void loop() {
    if ((int)(digitalRead(33)) == 0) {
      while (1) {
        ...
        delay(50);
        if ((ir_left == 1 && ir_right == 0) && hasObject <= 22) { //ultrasonic, left
          ...
          digitalWrite(13,HIGH);
          digitalWrite(14,LOW);
          analogWrite(25,0); // motor m1
          digitalWrite(18,HIGH);
          digitalWrite(19,LOW);
          analogWrite(15,200); // motor m2
          delay(480);
        // emo boy
        } else if ((ir_left == 0 && ir_right == 1) && hasObject <= 22) { //ultrasonic, right
          ...
          digitalWrite(13,HIGH);
          digitalWrite(14,LOW);
          analogWrite(25,200); // motor m1
          digitalWrite(18,HIGH);
          digitalWrite(19,LOW);
          analogWrite(15,0); // motor m2
          delay(480);
          ...
          sharp_left();
          delay(5);
        } else if ((ir_left == 1 && ir_right == 1 || ir_left == 0 && ir_right == 0) && hasObject > 22) {
          straight();
          delay(10);
        }
      }
